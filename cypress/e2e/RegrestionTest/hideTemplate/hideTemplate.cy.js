...
import hideTemplateActions from "../../../PageOpjects/hideTemplate/actions.cy";
import hideTemplateAssertions from "../../../PageOpjects/hideTemplate/assertions.cy";
...
When("The user click right Click on card",()=>{
    hideTemplateAction.rightClickOnCard();
    });
    When("The user click on hide from list",()=>{
    hideTemplateAction.hideFromList();
    });
